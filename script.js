...
const Reminder: React.FC = () => {
  return(
    <div className="reminder">
      ...
      <span className="reminder-text">NEW STUFF COMING SOON: <span className="reminder-time">IN 2023!</span></span>      
    </div>
  )
}
...
const Pin: React.FC = () => {
  ...
  return(
    <div id="app-pin-wrapper">
      ...
      <h3 id="app-pin-label">Enter your HC member ID {getErrorText()} {getCancelText()}</h3>
    </div>
  )
}
